  ...
  return (
    <div className="block rounded-lg p-4 shadow-sm shadow-indigo-100">
      <div>
        ...
        <Link
          to={`/post/${encodeURIComponent(album.artist)}/${encodeURIComponent(
            album.name
          )}/${encodeURIComponent(album.genre)}/${encodeURIComponent(
            album.year
          )}/${encodeURIComponent(album.stars)}/${encodeURIComponent(
            album.imageUrl
          )}/${encodeURIComponent(album.description)}`}
        >
          <img
            alt=""
            src={album.imageUrl}
